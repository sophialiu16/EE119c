...
HD_PWD='C:/Users/Soph/Documents/College/Senior/EE119c/FMReceiver/FMReceiver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MixerTB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MixerTB.tcl -notrace
